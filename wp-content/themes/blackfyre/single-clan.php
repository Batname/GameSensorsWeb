...
<?php
    ...
    $team_id = blackyfyre_return_team_id_by_post_id($p_id);
...
<div id="mainwrap" class="container clan-page normal-page">
        ...
        <div class="pmi_title">
            ...
            <?php if(blackfyre_is_super_admin($p_id,$c_id)){ ?>
    ...
    <div class="project_page">
        <div class="row">
<?php $matches = blackyfyre_return_all_clan_matches($team_id[0]->id);
	  $br_notifikacija = 0;
 foreach ($matches as $match) {
 	 if($team_id[0]->id != $challenge->team1 && blackfyre_is_admin($p_id, get_current_user_id()) &&
     ($match->status == 'submitted2' || $match->status == 'submitted1' || $match->status == 'deleted1' || $match->status == 'deleted2')){
     	$br_notifikacija++;
	 }
} ?>
  <ul class="nav nav-tabs clan-nav">
        ...
        <li><a data-toggle="tab" href="#members_tab"><i class="fa fa-users"></i><?php esc_html_e(' Members', 'blackfyre');?></a></li>
        ...
        <?php if(blackfyre_is_admin($p_id,$c_id)){
        	$challenges = blackyfyre_return_all_clan_challenges($team_id[0]->id);
        ...
        <div id="matches" class="tab-pane clanpage-matches">
            ...
            <?php if(!empty($matches[0])){ ?>
             ...
             <?php
                   ...
                   $results_matches = blackyfyre_return_match_score($matches[0]->id);
            ...
            <a href="<?php echo esc_url(get_permalink($matches[0]->post_id)); ?>" class="match-fimage-wrapper">
                ...
                <div class="clan-a">
                     <div class="clanimgw">
                    <img alt="img" src="<?php echo esc_url(blackyfyre_return_clan_image_big($matches[0]->team1)); ?>" />
                    ...
                    <div class="pmi_title"><?php $name1 = blackyfyre_return_team_name_by_team_id($matches[0]->team1); echo esc_attr($name1[0]->title); ?></div>
                </div>
                ...
                <div class="clan-b">
                      <div class="clanimgw">
                    <img alt="img" src="<?php echo esc_url(blackyfyre_return_clan_image_big($matches[0]->team2)); ?>" />
                    ...
                    <div class="pmi_title"><?php $name2 = blackyfyre_return_team_name_by_team_id($matches[0]->team2); echo esc_attr($name2[0]->title); ?></div>
                </div>
            ...
            <?php if(blackfyre_is_admin($p_id, get_current_user_id())){ ?>
                 <!-- CHALLENGES -->
            <?php $challenges = blackyfyre_return_all_clan_challenges($team_id[0]->id);
                ...
                <li class="notsubmitted">
                	<div class="member-list-wrapper">
	                    <a href="<?php echo esc_url(get_permalink($challenge->post_id)); ?>">
	                        <div class="clana">
	                            <img alt="img" src="<?php echo esc_url(blackyfyre_return_clan_image($challenge->team1)); ?>" class="avatar" />
	                            <span>0</span>
	                        </div>
	                        <strong><?php esc_html_e('VS', 'blackfyre'); ?></strong>
	                        <div class="clanb">
	                            <img alt="img" src="<?php echo esc_url(blackyfyre_return_clan_image($challenge->team2)); ?>"  class="avatar" />
	                            <span>0</span>
	                        </div>
	                        <div class="minfo">
                    ...
                    <div class="member-list-more">
                    	<div class="mlm1 mj">
                    	    ...
                    	    <?php if($team_id[0]->id == $challenge->team1){ ?>
		               		...
		               		<?php }else{ ?>
		               		    <a href="<?php echo esc_url(get_permalink(blackyfyre_return_team_post__by_team_id($challenge->team1)->post_id)); ?>"><?php $n = blackyfyre_return_team_name_by_team_id($challenge->team1); echo esc_attr($n[0]->title); ?></a>
           ...
           <!-- /CHALLENGES -->
            ...
            <?php } ?>
               ...
               <?php
                ...
                $results_matches = blackyfyre_return_match_score($match->id);
                ...
                $teams = blackyfyre_return_teams_by_match_id($match->id);
                $team1 = $teams->team1;
                $team2 = $teams->team2;
                $tim1 = blackyfyre_return_post_id_by_match_id(blackyfyre_return_team_ids_from_match_by_match_id($match->id)->team1);
                $tim2 = blackyfyre_return_post_id_by_match_id(blackyfyre_return_team_ids_from_match_by_match_id($match->id)->team2);
                    ...
                    <a href="<?php echo esc_url(get_permalink($match->post_id)); ?>">
                        <?php if(!isset($challenge->team1)){$challenge = new stdClass();$challenge->team1 = '';} ?>
                          ...
                          ($match->status == 'submitted2' || $match->status == 'submitted1' || $match->status == 'deleted1' || $match->status == 'deleted2')){ ?>
                            ...
                            <?php } ?>
                        <div class="clana">
                            <img alt="img" src="<?php echo esc_url(blackyfyre_return_clan_image($match->team1)); ?>" class="avatar" />
                        ...
                        <strong><?php esc_html_e('VS', 'blackfyre'); ?></strong>
                        <div class="clanb">
                            <img alt="img" src="<?php echo esc_url(blackyfyre_return_clan_image($match->team2)); ?>"  class="avatar" />
            ...
            <?php $matc = blackyfyre_return_all_clan_matches($team_id[0]->id); ?>
