...
<div class="<?php if ( of_get_option('fullwidth') ) {  }else{ ?>container boxed<?php } ?> blog normal-page container-wrap">
  ...
  <div class="row">
         <div class="isoblog col-lg-12 col-md-12"> <!-- new line -->
        <?php
		...
		<div class="blog-twrapper">
         ...
         <div class="blog-info">
                    ...
                    <div class="post-pinfo">
                        <span class="icon-user"></span> <a data-original-title="<?php esc_html_e("View all posts by ", 'blackfyre'); ?><?php echo esc_attr(get_the_author()); ?>" data-toggle="tooltip" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo esc_attr(get_the_author()); ?></a> &nbsp;
