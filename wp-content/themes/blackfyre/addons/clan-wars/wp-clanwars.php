...
<?php
    ...
    function update_match_post($match_id) {
        ...
        $post_content .= '</div><div class="clan-a">
            <div class="clanimgw">
            <img alt="img" src="'.blackyfyre_return_clan_image_big($m->team1).'" />
        ...
        <div class="clan-b">
            <div class="clanimgw">
            <img alt="img" src="'.blackyfyre_return_clan_image_big($m->team2).'" />
    ...
    function delete_match($id)
    {
		...
		$post_id = blackyfyre_return_post_id_by_match_id_from_matches($id);
            ...
            <div class="wrap wp-cw-matcheditor">
                ...
                <?php endif; ?>
                    ...
                    <form name="match-editor" id="match-editor" method="post" action="<?php echo esc_attr($_SERVER['REQUEST_URI']); ?>" enctype="multipart/form-data">
                        ...
                        <?php $status = blackyfyre_return_match_status($post_id); ?>
                         ...
                         <tr class="form-field form-required">
                            ...
                            <td>
                                 <p class="description"><?php if($status->status == 'submitted1'){
                                 	$name = blackyfyre_return_team_name_by_team_id($team1);
                                    echo esc_attr($name[0]->title);
                                 }elseif($status->status == 'submitted2'){
                                 	$name = blackyfyre_return_team_name_by_team_id($team2);
                                    echo esc_attr($name[0]->title);
                                 }   ?></p>
                            </td>
                        </tr>
