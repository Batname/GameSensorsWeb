...
?>
     <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                      ...
                      $('#mtch').on('click', 'a.ajaxdeletematch', function(){
                            "use strict";
                             $.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {"action": "blackfyre_match_delete", "req":$(this).attr('data-req'),  "mid":$(this).attr('data-mid'), "pid":$(this).attr('data-pid') },
                        ...
                        $('#score_fin').on('click', 'a.ajaxdeletescorenotification', function(){
                            "use strict";
                             $.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {"action": "blackfyre_match_delete_notification", "req":$(this).attr('data-req'), "mid":$(this).attr('data-mid')},
                                success: function(response) {
                                   NotifyMe(settingsNoty.match_deleted, "information");
                                   location.reload();
                                   return false;
