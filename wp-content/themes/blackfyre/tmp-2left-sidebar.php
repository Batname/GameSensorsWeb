...
?>
<?php get_header(); ?>
<?php if (class_exists('BlackfyreMultiPostThumbnails')) : $custombck = BlackfyreMultiPostThumbnails::get_post_thumbnail_url(get_post_type(), 'header-image-post', $post->ID, 'full'); endif; ?>
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-md-8 ">
        ...
        <div class="blog-info">
                    <div class="post-pinfo">
                        <span class="fa fa-user"></span> <a data-original-title="<?php _e("View all posts by", 'blackfyre'); ?> <?php echo esc_attr(get_the_author()); ?>" data-toggle="tooltip" href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>"><?php echo esc_attr(get_the_author()); ?></a> &nbsp;
    ...
    <div class="author-block wcontainer">
                ...
                <div class="author-content">
                    <h3><?php _e("About ", 'blackfyre'); ?> <?php echo esc_attr(get_the_author()); ?></h3>
